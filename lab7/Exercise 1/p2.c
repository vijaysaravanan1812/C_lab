...
void multiply(int (* arr1)[10],int (*arr2)[10],int (* arr3)[10],int rows1,int columns1,int rows2,int columns2)
{
...
void addition(int (* arr1)[10],int (* arr2)[10], int (* arr3)[10] ,int rows ,int columns)
{
